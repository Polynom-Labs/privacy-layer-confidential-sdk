...
| --- | --- | --- |
| **In-memory** | `@arcanetech/privacy-sdk-state-memory` | Scripts, prototypes, unit tests |
| **Redux** | `@arcanetech/privacy-sdk-state-redux` | React apps already using Redux Toolkit |
...
Zero extra dependencies. Data is lost when the process ends. Use this path in [Quick start](/integration/quick-start).
