---
title: Operations
description: Deposit, withdraw, and transfer — inputs, effects, and typical disclosure
---
...
<Note>
  Stellar addresses, seed-state fixtures, and full code blocks live in the [how-to guides](/application-development/how-to/deposit). Seed state blocks are **documentation fixtures**, not production onboarding — see [Data sources](/integration/data-sources).
</Note>
