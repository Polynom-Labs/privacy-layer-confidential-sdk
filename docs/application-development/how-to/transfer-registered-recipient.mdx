...
- `direct` — `await operation.execute({})` (example below)
- `relay` — wire `@arcanetech/privacy-sdk-relay` as in [Quick start Step 6](/integration/quick-start#step-6--protocol-relay-optional)
