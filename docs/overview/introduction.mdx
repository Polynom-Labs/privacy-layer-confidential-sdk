...
| Layer | Packages | Role |
| --- | --- | --- |
| **Core + state** | `@arcane/privacy-sdk-core`, `@arcane/privacy-sdk-state-*` | Chain-agnostic intents, operation lifecycle, errors, progress events, pluggable state |
| **Network preset** | `@arcane/privacy-sdk-stellar` (first shipped preset) | Binding to a specific blockchain: contracts, wallet format, bundled runtime assets |
