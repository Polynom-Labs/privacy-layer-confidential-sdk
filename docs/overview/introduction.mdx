...
4. **[Quick start](/integration/quick-start)** — choose a frontend or backend demo and run a deposit.
5. **[Stellar application development](/application-development/install)** — React package lines and operation how-tos.
