...
- **Relay** — chain-agnostic protocol relay runtime: admission, polling, retry, and fallback over caller-supplied ports. It never inspects opaque package payloads.
...
| `@arcanetech/privacy-sdk-relay` | Protocol relay runtime (ports, polling, retry, fallback) |
